    ...
    <main className='container__login'>
      ...
      >
        <form className='form__login' onSubmit={handleSubmit(onLoginSubmit)}>
          ...
          >
            {loginLoading ? <span className='chaotic-orbit'></span> : 'Login'}
          </motion.button>
        </form>
        <motion.button
          whileHover={{ scale: 1.1 }}
        ...
        <Link to={'/forgot'}>
          <p className='signup__para signup__link'>Forgot password?</p>
        </Link>
        <p className='signup__para signup__para--login'>
          Not a user?{' '}
          <Link to={'/register'}>
